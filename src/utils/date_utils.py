"""
Date utility functions for Dutch date formatting and business day calculations.
"""
...
def get_dutch_date(date: datetime, include_time: bool = False) -> str:
    ...
    Args:
        ...
        include_time: If True, includes time in format 'HH:MM'
...
def get_next_business_days(start_date: datetime, num_days: int) -> list[datetime]:
    ...
    Returns:
        List of datetime objects for the next N business days
    """
    business_days = []
    current = start_date
