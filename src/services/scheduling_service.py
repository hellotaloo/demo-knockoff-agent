...
class SchedulingService:
    ...
    async def save_scheduled_slot(
        ...
        interview_id = await self.repo.create(
            ...
            application_id=conv_info.get("application_id"),
            candidate_id=conv_info.get("candidate_id"),
        ...
        return {
            ...
            "candidate_id": str(conv_info["candidate_id"]) if conv_info.get("candidate_id") else None,
            "application_id": str(conv_info["application_id"]) if conv_info.get("application_id") else None,
